...
namespace EasyMobile.Demo
{
    public class NotificationsDemo : MonoBehaviour
    {
        ...
        public void ScheduleLocalNotification()
        {
            ...
            TimeSpan delay = new TimeSpan(delayHours, delayMinutes, delaySeconds);
            Notifications.ScheduleLocalNotification(delay, notif);
        }
            ...
            Notifications.GetPendingLocalNotifications(pendingNotifs =>
                {
                    ...
                    foreach (var req in pendingNotifs)
                    {
                        ...
                        sb.Append("ID: " + req.id.ToString() + "\n")
                            ...
                            .Append("NextTriggerDate: " + req.nextTriggerDate.ToLocalTime().ToShortDateString() + " " + req.nextTriggerDate.ToLocalTime().ToShortTimeString() + "\n")
