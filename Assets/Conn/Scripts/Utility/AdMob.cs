...
public class AdMob : MonoBehaviour
{
		...
		public string androidNativeExpressAdUnitID;
		public string IOSNativeExpressAdUnitID;
...
/*		public void RequestNativeExpressAdView(AdPosition adPosition)
		{
			#if UNITY_ANDROID
				string adUnitId = androidNativeExpressAdUnitID;
			#elif UNITY_IPHONE
				string adUnitId = IOSNativeExpressAdUnitID;
			#else
				string adUnitId = "unexpected_platform";
			#endif
			...
			//Destroy current NativeExpress ad, if exists
			...
			this.nativeExpressAdView.LoadAd(request);
		} */
